#!/bin/bash
# This script automates the development of e-commerce application
...
function is_firewalld_rule_configured(){
  firewalld_ports=$(sudp firewall-cmd --list-all --zone=public | grep ports)
...
#sudo vi /etc/my.cnf Dont neet to make any changes to the port
...
then
  print_color "gree" "Inventory data loaded"
else
...
print_color "green" "Configuring firwallD rules for Webserver..."
...
sudo git clone https://github.com/kodekloudhub/learning-app-ecommerce.git /var/www/html/index.php

#Replace database IP with localhost
#sudo sed -i 's/192.168.15.162/localost/g' /var/www/html/
